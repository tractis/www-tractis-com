...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
			...
			<div class="<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
				...
				<img src="<?php gravatar("R", 32,  "http://www.tractis.com/blog/blog/es/wp-content/themes/minid/images/cobarde-anonimo.png"); ?>" alt="Gravatar de <?php comment_author(); ?>" title="Gravatar de <?php comment_author(); ?>" />
